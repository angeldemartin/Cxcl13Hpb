...
selGenes <- data.frame(geneID=c("Ly6a","Acta2","Cd81","Cd34","Pdgfra","Pdpn")) %>% left_join(., genes, by="geneID")

DotPlot(seuratFb, features = selGenes, group.by= "cluster_name") + RotatedAxis() + scale_color_viridis(option="D") + coord_flip()
```
