...
Idents(seuratFb) <- seuratFb$cond3
table(seuratFb$cond3)
DimPlot(seuratFb, reduction= "umap", cols = colcond3)
DimPlot(seuratFb, reduction= "umap", cols = colcond3) + theme(legend.position = "none")
...
```{r feature plots fb}
## plot feature
FeaturePlot(seuratFb, features = "ENSMUSG00000028583.Pdpn", cols = c("lightgrey", "#BE3144"))
FeaturePlot(seuratFb, features = "Rosa26eyfp.Rosa26eyfp", cols = c("lightgrey", "#BE3144"))
FeaturePlot(seuratFb, features = "ENSMUSG00000035783.Acta2", cols = c("lightgrey", "#BE3144"))
FeaturePlot(seuratFb, features = "ENSMUSG00000016494.Cd34", cols = c("lightgrey", "#BE3144"))
FeaturePlot(seuratFb, features = "ENSMUSG00000029231.Pdgfra", cols = c("lightgrey", "#BE3144"))
FeaturePlot(seuratFb, features = "ENSMUSG00000023078.Cxcl13", cols = c("lightgrey", "#BE3144"))
FeaturePlot(seuratFb, features = "ENSMUSG00000071005.Ccl19", cols = c("lightgrey", "#BE3144"))
FeaturePlot(seuratFb, features = "ENSMUSG00000039542.Ncam1", cols = c("lightgrey", "#BE3144"))
FeaturePlot(seuratFb, features = "ENSMUSG00000075602.Ly6a", cols = c("lightgrey", "#BE3144"))
FeaturePlot(seuratFb, features = "ENSMUSG00000037706.Cd81", cols = c("lightgrey", "#BE3144"))
FeaturePlot(seuratFb, features = "ENSMUSG00000020717.Pecam1", cols = c("lightgrey", "#BE3144"))
FeaturePlot(seuratFb, features = "ENSMUSG00000045394.Epcam", cols = c("lightgrey", "#BE3144"))
```
