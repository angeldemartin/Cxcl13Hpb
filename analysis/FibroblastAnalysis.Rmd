...
FeaturePlot(seuratFb, features = "ENSMUSG00000020676.Ccl11", cols = c("lightgrey", "#BE3144"), pt.size = 1, split.by = "cond3")
FeaturePlot(seuratFb, features = "ENSMUSG00000020676.Ccl11", cols = c("lightgrey", "#BE3144"), pt.size = 1, split.by = "cond3") + theme(legend.position = "none") + ggtitle(NULL)
```
