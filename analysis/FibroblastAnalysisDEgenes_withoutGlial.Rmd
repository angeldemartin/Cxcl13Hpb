---
title: "FibroblastanalysisDEgenes_withoutGlial"
author: "A.DeMartin"
date: "2025-06-10"
output: 
  html_document:
...
write.table(markerGenes, 
            file= "/Users/immbio/Desktop/Project/Angelina/Cxcl13Hpb/data/FbmarkerGenesclustername_noGlial.txt",
            sep="\t",
            quote=F,
            row.names=F,
            col.names=T)
...
write.table(DEGenesFbcond3, 
            file= "/Users/immbio/Desktop/Project/Angelina/Cxcl13Hpb/data/DEGenesFbcond3_noGlial.txt",
            sep="\t",
            quote=F,
            row.names=F,
            col.names=T)
...
## load DEGenesFbcond3
DEGenesFbcond3 <- read.delim("/Users/immbio/Desktop/Project/Angelina/Cxcl13Hpb/data/DEGenesFbcond3_noGlial.txt", header = TRUE, sep = "\t")
...
write.table(DEGenesFbcond2, 
            file= "/Users/immbio/Desktop/Project/Angelina/Cxcl13Hpb/data/DEGenesFbcond2_noGlial.txt",
            sep="\t",
            quote=F,
            row.names=F,
            col.names=T)
...
## load DEGenesFbcond2
DEGenesFbcond2 <- read.delim("/Users/immbio/Desktop/Project/Angelina/Cxcl13Hpb/data/DEGenesFbcond2_noGlial.txt", header = TRUE, sep = "\t")
...
```{r dotplot genes GSEA intersect-2, fig.height=3.5, fig.width=7}
genes <- data.frame(gene=rownames(seuratFb)) %>% 
  mutate(geneID=gsub("^.*\\.", "", gene))
